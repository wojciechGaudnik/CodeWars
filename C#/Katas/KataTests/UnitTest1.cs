...
[Test]
    public static void test1()
    {
        ...
        assertFuzzyEquals(kyu6Rainfall.Mean("London", RainfallTests.data), 51.199999999999996);
        assertFuzzyEquals(kyu6Rainfall.Mean("Beijing", RainfallTests.data), 52.416666666666664);
    }
[Test]
     public static void test2()
     {
         Console.WriteLine("Fixed Tests: variance data");
         assertFuzzyEquals(kyu6Rainfall.Variance("London", RainfallTests.data), 57.42833333333374);
         assertFuzzyEquals(kyu6Rainfall.Variance("Beijing", RainfallTests.data), 4808.37138888889);
     }
}