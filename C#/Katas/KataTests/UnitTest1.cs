...
namespace Solution
{
    ...
    public class KataTests
    {
        ...
        public void BasicTests()
        {
            Assert.AreEqual(1, kyu6FindTheDuplicatedNumberInAConsecutiveUnsortedListTougherVersion.FindDup(new[] { 1,2,3,1 }));
            Assert.AreEqual(1, kyu6FindTheDuplicatedNumberInAConsecutiveUnsortedListTougherVersion.FindDup(new[] { 5,4,3,2,1,1 }));
            Assert.AreEqual(5, kyu6FindTheDuplicatedNumberInAConsecutiveUnsortedListTougherVersion.FindDup(new[] { 1,3,2,5,4,5,7,6 }));
            Assert.AreEqual(2, kyu6FindTheDuplicatedNumberInAConsecutiveUnsortedListTougherVersion.FindDup(new[] { 8,2,6,3,7,2,5,1,4 }));
            Assert.AreEqual(1, kyu6FindTheDuplicatedNumberInAConsecutiveUnsortedListTougherVersion.FindDup(new[] { 1,1 }));
        }
    }
}
